...
{ 
 ...
 {
  while(!power);        //等待开机
  LED1=0;LED2=0;LED3=0;LED4=0;LED5=0;//LED全亮
  fmsound(1);//蜂鸣器响一声
  while(second==0);
  while(power)
  { 
   while(second>0&&second<=900)
	 {
	  LED1=1;LED2=0;LED3=1;LED4=1;LED5=1;//亮LED2
	  HOT=1;UL=1;FAN=1;hotfan=1;         //开热管，紫外灯，风扇
	 }
   while(second>900&&second<=2700)
	 {
	  LED1=1;LED2=1;LED3=0;LED4=1;LED5=1;//亮LED3
	  HOT=1;UL=1;FAN=1;hotfan=1;         //开热管，紫外灯，风扇
	 }
   while(second>2700)
	 {
	  LED1=1;LED2=1;LED3=1;LED4=0;LED5=1;//亮LED4
	  HOT=1;UL=1;FAN=1;hotfan=1;         //开热管，紫外灯，风扇
	 }
   while(second==0&&power)
	 {
	  LED1=0;LED2=1;LED3=1;LED4=1;LED5=1;//亮LED1
	  HOT=0;UL=0;                        //开热管，紫外灯，风扇
	 }		 
  } 
  LED1=1;LED2=1;LED3=1;LED4=1;LED5=1;//LED全灭
  HOT=0;UL=0;                        //关热管，紫外灯
  fmsound(1);//蜂鸣器响一声   
 }
}
